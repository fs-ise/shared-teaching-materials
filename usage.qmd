...
The variable can be defined in `_variables.yml` or project metadata in the respective Quarto project. This allows the same content to be rendered both directly within `shared-teaching-materials` and when included through the submodule in another teaching repository.
